...
s0_clear_button = <Shift><Alt><Super>Button3
s0_clear_key = <Shift><Alt><Super>k
...
[core]
s0_active_plugins = core;composite;crashhandler;opengl;decor;copytex;resize;obs;vpswitch;annotate;commands;dbus;imgpng;matecompat;wall;place;move;workspacenames;session;compiztoolbox;regex;grid;animation;mousepoll;snap;showmouse;expo;thumbnail;workarounds;fade;scale;ezoom;switcher;
...
[animation]
s0_open_effects = animation:Glide 2;animation:Glide 2;animation:Fade;animation:Fade;
s0_open_durations = 300;120;80;80;
s0_open_matches = class=Mate-menu.py;((type=Normal | Unknown) | name=sun-awt-X11-XFramePeer | name=sun-awt-X11-XDialogPeer) & !(role=toolTipTip | role=qtooltip_label) & !(type=Normal & override_redirect=1) & !(name=gnome-screensaver);((type=Menu | PopupMenu | DropdownMenu | Combo | Dialog | ModalDialog | Normal) & !(class=\.exe$));(type=Tooltip | Notification | Utility) & !(name=compiz) & !(title=notify-osd);
s0_open_options = ;;;;
s0_open_random_effects = 
s0_close_effects = animation:Glide 2;animation:Glide 2;animation:Fade;animation:Fade;
s0_close_durations = 200;120;80;50;
s0_close_matches = class=Mate-menu.py;((type=Normal | Unknown) | name=sun-awt-X11-XFramePeer | name=sun-awt-X11-XDialogPeer) & !(role=toolTipTip | role=qtooltip_label) & !(type=Normal & override_redirect=1) & !(name=gnome-screensaver) & !(name=gnome-screenshot);((type=Menu | PopupMenu | DropdownMenu | Combo | Dialog | ModalDialog | Normal) & !(class=\.exe$));(type=Tooltip | Notification | Utility) & !(name=compiz) & !(title=notify-osd);
s0_close_options = ;;;;
...
s0_active_shadow_opacity = 0,995000
s0_active_shadow_color = #000000b8
